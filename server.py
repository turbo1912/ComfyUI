    ...
    def __init__(self, loop):
        ...
        async def upload_mask(request):
            ...
            def image_save_function(image, post, filepath):
                original_pil = Image.open(post.get("original_image").file).convert(
                    "RGBA"
                )
        ...
        async def post_prompt(request):
            ...
            if "prompt" in json_data:
                ...
                if valid[0]:
                    ...
                    ##
                    print(outputs_to_execute)
                    # ADDED by gorkem: dont accept if queue is not empty
                    # if self.prompt_queue.not_empty:
